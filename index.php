...
<head>
    ...
    <title>PHARMEDICE - Platform Konsultasi Obat Online</title>
...
<body>
    ...
    <section id="about" class="about">
        <div class="container">
            <h2 class="section-title">Tentang PHARMEDICE</h2>
            <div class="about-content">
                <div class="about-text">
                    <p>PHARMEDICE adalah platform telefarmasi inovatif yang menggabungkan teknologi sistem pakar dengan layanan konsultasi obat online. Kami menggunakan metode <strong>Forward Chaining</strong> untuk menganalisis gejala dan memberikan rekomendasi obat yang tepat.</p>
