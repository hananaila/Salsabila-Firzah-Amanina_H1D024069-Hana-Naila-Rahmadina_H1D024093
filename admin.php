...
<head>
    ...
    <title>Admin Panel - PHARMEDICE</title>
    ...
    <div class="admin-dashboard">
        <div class="container">
            ...
            <div class="admin-header">
                ...
                <p>Kelola data sistem PHARMEDICE</p>
            </div>
            ...
            <div class="tab-content active" id="dashboard-tab">
                ...
                <p>Selamat datang di Admin Panel PHARMEDICE. Gunakan menu di atas untuk mengelola berbagai aspek sistem.</p>
